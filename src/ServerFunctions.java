...
/**
 * This class holds functions for inputing data from the Server and files and parsing through it in order to find the
 * data the Client is asking for.
 *
...
public class ServerFunctions {
    ...
    public static int validateUser(String email, ArrayList<String> accounts) {
        // 0 account is found, 1 account is available
        int validation = 1;
        for (String account : accounts) {
            String un = account.split(",")[0];
            if (un.equals(email)) {
