...
/**
 * This class holds all of the GUI for the user, and the processing of data sent from the Server in displaying it on
 * the GUI. Also includes the viewItemMenu submenu, and all input validation for the user.
 *
...
public class Client {
                    ...
                    switch (optionString) {
                        ...
                        case "5. View store sales statistics" -> {
                            ...
                            while (true) {
                                ...
                                printWriter.println(statsMenu);
                                if (statsMenu == 1 || statsMenu == JOptionPane.CLOSED_OPTION) {
                                    break;
                                }
                            }
                        }
    ...
    public static String[] accountInfo() {
        ...
        while (true) {
            ...
            if (!email.contains("@") || email.contains(",") || password.contains(",") || email.isBlank() ||
                    password.isBlank()) {
        ...
        if (userType.equals("seller")) {
            ...
            switch (menuOption) {
                ...
                case 1 -> { // remove product
                    ...
                    if (bufferedReader.readLine().equals("false")) {
                        JOptionPane.showMessageDialog(null,
                                "You can only remove your own books!", "Error",
                                JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                case 2 -> printWriter.println("back"); // go back to main menu
            }
        } else {
            ...
            switch (menuOption) {
                ...
                case 3 -> printWriter.println("back"); // go back to main menu
            }
        }
    }
}
