...
/**
 * This class holds all information from the files, and uses functions in the ServerFunctions and ClientFunctions classes
 * in order to translate data into a format usable by the Client. This class takes in information from the Client, and
 * sends back the data the Client is asking for, in the format the Client wishes to display. It is in the form of a
 * thread, so each Client can connect to a different Server.
 *
